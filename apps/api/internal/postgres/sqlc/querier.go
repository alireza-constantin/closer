...
type Querier interface {
	...
	CreatePrivateRound(ctx context.Context, arg CreatePrivateRoundParams) (PrivateRound, error)
	...
	GetActivePrivateRoundForPair(ctx context.Context, arg GetActivePrivateRoundForPairParams) (PrivateRound, error)

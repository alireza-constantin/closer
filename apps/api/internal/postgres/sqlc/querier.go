...
type Querier interface {
	...
	CreateRejoinParticipant(ctx context.Context, arg CreateRejoinParticipantParams) (CreateRejoinParticipantRow, error)
	CreateReplacementMembership(ctx context.Context, arg CreateReplacementMembershipParams) (pgtype.UUID, error)
	CreateReplacementMembershipEra(ctx context.Context, arg CreateReplacementMembershipEraParams) (pgtype.UUID, error)
	...
	EndMembershipEraForRejoin(ctx context.Context, arg EndMembershipEraForRejoinParams) (int64, error)
	EndMembershipForRejoin(ctx context.Context, arg EndMembershipForRejoinParams) (int64, error)
	...
	HasDuplicateActiveParticipantPairForRejoin(ctx context.Context, arg HasDuplicateActiveParticipantPairForRejoinParams) (bool, error)

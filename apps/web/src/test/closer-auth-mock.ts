...
export function createCloserAuthMock(overrides: CloserAuthMock = {}): CloserAuthMock {
  return {
    ...
    retireSharedOpenPrivateRound: unexpectedCloserAuthCall("retireSharedOpenPrivateRound"),
    advanceTogetherSession: unexpectedCloserAuthCall("advanceTogetherSession"),
    selectSharedOpenPrivateCandidate: unexpectedCloserAuthCall("selectSharedOpenPrivateCandidate"),

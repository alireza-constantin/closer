...
export default function JoinPairForm({
  ...
  return (
    <OnboardingSurface as="form" onSubmit={kind === "rejoin" ? form.handleSubmit(joinPair) : submitInitialClaim}>
      ...
      <p className="mt-3 max-w-[31ch] text-[.98rem] leading-relaxed text-closer-muted">{kind === "rejoin" ? "Choose a name to return to your place in this space. No sign-up needed." : "Review this space, then choose Join space when you’re ready."}</p>

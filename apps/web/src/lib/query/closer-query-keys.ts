export const closerKeys = {
  ...
  privateConversations: (pairId: string) =>
    ["closer", "pair", pairId, "private", "conversations"] as const,
  privateConversation: (pairId: string, conversationId: string) =>
    ["closer", "pair", pairId, "private", "conversation", conversationId] as const,
  privateRound: (pairId: string, roundId: string) =>
    ["closer", "pair", pairId, "private", "round", roundId] as const,

...
export default function PrivatePicker({
  pairId,
  relationshipType,
}: {
  pairId: string;
  ...
  async function openCategory(category: CloserCategory) {
    ...
    try {
      ...
      const destination =
        "roundId" in body && typeof body.roundId === "string"
  ...
  return (
    <CloserPageShell className="pt-5">
      ...
      <section className="pt-10">
        ...
        <h1 className="mt-6 max-w-[12ch] text-[2.25rem] leading-tight font-extrabold tracking-[-.048em] text-balance">
          What kind of question feels right?
        </h1>
        <p className="text-closer-muted mt-3 max-w-[32ch] leading-relaxed">
          Choose a topic. We’ll bring you back to it whenever you want.
        </p>

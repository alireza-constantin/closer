...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card rounded-closer-card bg-card text-card-foreground shadow-closer-soft ring-closer-navy/5 flex flex-col gap-(--card-spacing) overflow-hidden py-(--card-spacing) text-sm/relaxed ring-1 [--card-spacing:--spacing(5)] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-[inherit] *:[img:last-child]:rounded-[inherit]",
        className,
      )}
      {...props}
    />

...
const cases = [
  ...
  {
    id: "pair.rejoin-replacement-era",
    area: "pair-invite-era",
    gate: "must-pass-before-cutover",
    title: "Guest rejoin creates a replacement identity and era in the same logical slot",
    preconditions: [
    ...
    expected: {
      ...
      persistedState: {
        participantIdChanged: true,
        membershipIdChanged: true,
        logicalSlotUnchanged: true,
        membershipEraIdChanged: true,
        pairIdUnchanged: true,
        participantCountIncreasedBy: 1,
        membershipCountIncreasedBy: 1,
        eraCountIncreasedBy: 1,
        oldMembershipEnded: true,
        oldEraEnded: true,
        oldDisplayNameFrozen: true,
        oldHistoryBoundToOldEra: true,
        oldAuthSessionsRevoked: true,
      },
      projections: [
        { actor: "fresh-anonymous-auth", mustResolveParticipant: "$new-participant" },
        {
          actor: "replacement",
          mustOmit: [
            "oldPrivateAnswers",
    ...
    sources: [
      "apps/api/internal/httpapi/rejoin_integration_test.go — rejoin creates a new Participant, membership, and era",
      "docs/rewrite/PARITY-CHECKLIST.md — guest rejoin replacement and old-era isolation gates",
    ],
  },
  {
